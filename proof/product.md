A product is something you've built: an application (web, mobile, command line, etc.), software library with the aim of creating value for an audience that uses your product.

The most impressive products create value: they're used by other people (even if a few). Having users legitimizes a product: it demonstrates a range of skills: 
